...
local Library = {
	Themes = {
		Blackout = {
			...
			Tertiary = Color3.fromRGB(120, 81, 169),
...
function Library:create(options)
	...
	if readfile and writefile and isfile then
		if not isfile("BlackoutHub/MercurySettings.json") then
			writefile("BlackoutHub/MercurySettings.json", HTTPService:JSONEncode(settings))
		end
		settings = HTTPService:JSONDecode(readfile("BlackoutHub/MercurySettings.json"))
	...
	rawset(mt, "creditsContainer", creditsTab.container)
        ...
        creditsTab:credit{Name = string.reverse("elpaM"), Description = "Script Developer", Discord = string.reverse("9232#narF taC kcalB"), V3rmillion = string.reverse("elpaMlluN")}
        creditsTab:credit{Name = string.reverse("gnoB"), Description = "Script Developer", Discord = string.reverse("0670#gnobeZ"), V3rmillion = string.reverse("rekcuZ")}
